...
const codeSnippet = [
  { num: 1, parts: [{ t: 'keyword', v: 'const ' }, { t: 'var', v: 'app' }, { t: 'op', v: ' = ' }, { t: 'fn', v: 'createApp' }, { t: 'plain', v: '({' }] },
  { num: 2, parts: [{ t: 'plain', v: '  stack: [' }, { t: 'str', v: "'Next.js'" }, { t: 'plain', v: ', ' }, { t: 'str', v: "'TypeScript'" }, { t: 'plain', v: '],' }] },
  { num: 3, parts: [{ t: 'plain', v: '  database: ' }, { t: 'str', v: "'PostgreSQL'" }, { t: 'plain', v: ',' }] },
  { num: 4, parts: [{ t: 'plain', v: '  deploy: ' }, { t: 'str', v: "'Vercel'" }, { t: 'plain', v: ',' }] },
  { num: 5, parts: [{ t: 'plain', v: '  client: ' }, { t: 'str', v: "'votre-entreprise'" }] },
