...
export const metadata: Metadata = {
  title: "Nos services",
  description:
    "Découvrez nos offres web sur mesure : site vitrine, module de réservation en ligne et application métier. Développement professionnel sans template. Devis gratuit.",
  openGraph: {
    title: "Nos services | Becee",
    description:
      "Sites vitrines, réservation en ligne et applications métier sur mesure. Devis gratuit sous 24h.",
    url: "/services",
  },
};
            ...
            {tiers.map((tier, i) => (
              <AnimatedCard key={tier.name} delay={i * 0.12}>
                ...
                >
                  ...
                  <p className="font-inter text-xs text-muted-foreground mt-1 mb-3 tracking-wide">
                    {tier.subtitle}
                  </p>
