...
export const metadata: Metadata = {
  title: "À propos",
  description:
    "Découvrez Becee : notre histoire, nos valeurs et notre méthodologie. Une agence web dédiée à la réussite digitale des PME et indépendants français.",
  openGraph: {
    title: "À propos | Becee",
    description:
      "Notre histoire, nos valeurs et notre méthodologie au service de votre projet web.",
    url: "/a-propos",
  },
};
...
const values = [
  {
    ...
    description:
      "Nous utilisons les technologies les plus performantes et appliquons les meilleures pratiques de développement à chaque projet.",
  },
  {
    icon: Heart,
    title: "Engagement client",
    description:
      "La réussite de votre projet est notre priorité. Nous construisons des relations de confiance à long terme avec chaque client.",
  },
  {
    icon: Shield,
    title: "Transparence totale",
    description:
      "Communication claire, devis détaillés, suivi en temps réel. Vous avez une visibilité complète à chaque étape.",
  },
  {
    icon: Lightbulb,
    title: "Innovation pragmatique",
    description:
      "Nous innovons quand cela apporte une valeur réelle à votre activité, pas pour la technologie en soi.",
  },
];
...
const methodology = [
  {
    ...
    description:
      "Nous analysons vos besoins, votre marché et vos objectifs pour définir la solution la plus adaptée.",
  },
  {
    step: "02",
    icon: PenTool,
    ...
    description:
      "Maquettes et prototypes interactifs pour valider l'expérience utilisateur avant le moindre code.",
  },
  {
    step: "03",
    icon: Code2,
    title: "Développement",
    description:
      "Développement itératif avec des livraisons régulières. Vous testez et validez à chaque sprint.",
  },
  {
    step: "04",
    icon: Rocket,
    ...
    description:
      "Mise en production, formation et accompagnement. Nous restons à vos côtés après le lancement.",
  },
];
...
const team = [
  {
    ...
    description:
      "React, Node.js, TypeScript — notre cœur technique qui donne vie à vos projets.",
  },
  {
    icon: Palette,
    role: "Designers UI/UX",
    description:
      "Interfaces élégantes et expériences utilisateur intuitives, pensées pour la conversion.",
  },
  {
    icon: BarChart3,
    role: "Stratèges Digitaux",
    description:
      "SEO, performance et croissance — chaque décision est guidée par vos objectifs business.",
  },
  {
    icon: Headphones,
    role: "Support & Accompagnement",
    description:
      "Réactivité et disponibilité pour assurer le bon fonctionnement de vos solutions.",
  },
];
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
          <SectionHeading
            ...
            title="Une agence née d'une conviction"
          />
            ...
            {values.map((v, i) => (
              <AnimatedCard key={v.title} delay={i * 0.1}>
                <div className="h-full border border-[#E8E8E8] rounded p-6 bg-white hover:border-accent/30 transition-colors">
                  ...
                  <h3 className="font-playfair text-lg font-medium mb-2 text-foreground">
                    {v.title}
                  </h3>
            ...
            {team.map((member, i) => (
              <AnimatedCard key={member.role} delay={i * 0.1}>
                <div className="text-center h-full border border-[#E8E8E8] rounded p-7 bg-white hover:border-accent/30 transition-colors">
                  ...
                  <h3 className="font-playfair text-base font-medium mb-2 text-foreground">
                    {member.role}
                  </h3>
                  <p className="font-inter text-sm text-muted-foreground leading-relaxed">
                    {member.description}
            ...
            {stats.map((stat, i) => (
              <AnimatedCard key={stat.label} delay={i * 0.1}>
                <div className="text-center py-6 px-4">
                  <div className="font-playfair text-4xl sm:text-5xl font-medium text-accent mb-1.5">
                    {stat.value}
                  </div>
