...
const contactInfo = [
  { icon: Mail, label: 'Email', value: 'contact@studiodev.fr', href: 'mailto:contact@studiodev.fr' },
              ...
              <form onSubmit={handleSubmit} className="border border-[#E8E8E8] rounded p-7 sm:p-8 bg-white space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div className="space-y-1.5">
                    ...
                    <Input id="name" value={form.name} onChange={(e) => updateField('name', e.target.value)} placeholder="Jean Dupont" required className="font-inter text-sm bg-[#FAFAFA] border-[#E8E8E8] h-10 rounded-sm focus:border-foreground/30" />
                  </div>
                  <div className="space-y-1.5">
                    <Label htmlFor="email" className="font-inter text-xs font-medium tracking-wide text-foreground">Email</Label>
                    <Input id="email" type="email" value={form.email} onChange={(e) => updateField('email', e.target.value)} placeholder="jean@entreprise.fr" required className="font-inter text-sm bg-[#FAFAFA] border-[#E8E8E8] h-10 rounded-sm focus:border-foreground/30" />
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div className="space-y-1.5">
                    ...
                    <Input id="phone" type="tel" value={form.phone} onChange={(e) => updateField('phone', e.target.value)} placeholder="06 12 34 56 78" className="font-inter text-sm bg-[#FAFAFA] border-[#E8E8E8] h-10 rounded-sm" />
                  </div>
                  <div className="space-y-1.5">
